...
idx_job_array = int(sys.argv[2]) # job array starts from 1, represents repetitions
idx_1 = int(sys.argv[3])  # index for msmt pair
idx_2 = int(sys.argv[4])  # index for lambda pair
...
fname_likelihood = 'scaling_'+str(idx_1)+'_'+str(idx_2)+'_'
