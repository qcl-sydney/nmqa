...
for idx_truth_flag in range(5):
    ...
    SIMULATIONSDICT[idx_truth_flag]["GRAPHMIN"] = -1.9 #-2.5 # Figure plotting
...
SIMULATIONSDICT[2]["R_MAX"] = 100 # Figure plotting
...
for idx_figure in range(2):
    ...
    fig = plt.figure(figsize=(cm2inch(3.25),cm2inch(3)))
    gslayout = gs(2,2, top = 0.99, bottom =0.1, left = 0.15, right = 0.98, wspace = 0.4, hspace = 0.4)
