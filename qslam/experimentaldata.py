...
DataSetProperties_2['parameters'] = None  # np.load(DataSetProperties_2['path'])['DataParams'].item()
...
DataSetProperties_3['parameters'] = None # np.load(DataSetProperties_3['path'])['DataParams'].item()
...
DataSetProperties_4['parameters'] =  None # np.load(DataSetProperties_4['path'])['DataParams'].item()
